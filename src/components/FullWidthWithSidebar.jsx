...
const navigation = [
  ...
  // { name: "Insurance", href: "#", icon: ShieldCheckIcon, current: true },
  { name: "Partners", href: "#", icon: UserGroupIcon, current: true },
];
const teams = [
...
export default function FullWidthWithSidebar() {
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col lg:border-r lg:border-gray-200 lg:bg-gray-100 lg:pt-5 lg:pb-4">
          <div className="flex flex-shrink-0 items-center px-6">
            {/* <img
              ...
              alt="Your Company"
            /> */}
            <BuildingStorefrontIcon className="h-8 w-auto text-purple-600" />
          </div>
          ...
          <main className="flex-1">
            ...
            {/* <section aria-labelledby="quick-links-title">
              <div className="divide-y divide-gray-200 overflow-hidden rounded-lg bg-gray-200 shadow sm:grid sm:grid-cols-2 sm:gap-px sm:divide-y-0">
                ...
                {resources.map((action, actionIdx) => (
                  <div
                    key={action.name}
                    className={classNames(
                      actionIdx === 0
                      ...
                      actionIdx === resources.length - 2
                        ? "sm:rounded-bl-lg"
                        : "",
                      actionIdx === resources.length - 1
            ...
            <div className="mx-auto max-w-7xl py-12 px-6 lg:py-0 lg:px-8">
              <div className="mt-6 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-8">
                <div className="col-span-1 flex justify-center bg-gray-50 py-8 px-8">
                  <img
                    className="w-[135px] max-h-6 mt-3"
                    src="https://coverdash.s3.amazonaws.com/images/docs/coverdash_logo_wide_gray_400.png"
                    alt="Workcation"
                  />
                </div>
                <div className="col-span-1 flex justify-center bg-gray-50 py-8 px-8">
